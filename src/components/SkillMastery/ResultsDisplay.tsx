...
interface ResultsDisplayProps {
    ...
    topic: string;
    difficulty: string;
    categoryPerformance: { [key: string]: { correct: number; total: number; percentage: number } };
    insights: {
        strengths: string[];
        weaknesses: string[];
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                >
                    <div className="space-y-2">
                        ...
                        <h1 className="text-5xl font-bold text-white">{score.percentage}%</h1>
                    </div>
                ...
                >
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="text-center p-4 rounded-lg bg-slate-900/50">
                            <p className="text-2xl font-bold text-gray-400 mb-2">{score.skipped}</p>
                ...
                {Object.keys(categoryPerformance).length > 0 && (
                    <motion.div
                        ...
                        className="bg-slate-800/50 rounded-lg border border-slate-700 p-6 space-y-4"
                    >
                        <h2 className="text-lg font-semibold text-white">Category-wise Performance</h2>
                        <div className="space-y-3">
                            {Object.entries(categoryPerformance).map(([category, data]: [string, any]) => (
                                <div key={category} className="space-y-2">
                                    ...
                                    <p className="text-xs text-gray-400 text-right">{data.percentage}%</p>
                                </div>
                            ))}
                        </div>
                    </motion.div>
