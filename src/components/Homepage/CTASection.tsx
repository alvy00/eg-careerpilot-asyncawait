        ...
        <section className="py-24 px-6 bg-background relative overflow-hidden">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col items-center gap-6">
                            ...
                            >
                                <Link
                                    href="/signup"
                                    className="group/btn relative inline-flex items-center gap-4 rounded-2xl px-12 py-5 overflow-hidden"
                                >
                                    {/* Button Background */}
                                    <div
                                        className="absolute inset-0 
                                    ...
                                    group-hover/btn:bg-primary/90 
                                    transition-all duration-500 rounded-2xl shadow-lg"
                                    />
                            ...
                            {/* Footer Note */}
                            <div className="flex items-center gap-2 text-[10px] text-foreground/40 font-mono tracking-widest uppercase font-bold">
                    ...
                    {/* Corner Accents */}
                    <div className="absolute top-0 left-0 w-16 h-16 border-t border-l border-glass-border rounded-tl-3xl pointer-events-none" />
                    <div className="absolute top-0 right-0 w-16 h-16 border-t border-r border-glass-border rounded-tr-3xl pointer-events-none" />
                    <div className="absolute bottom-0 left-0 w-16 h-16 border-b border-l border-glass-border rounded-bl-3xl pointer-events-none" />
                    <div className="absolute bottom-0 right-0 w-16 h-16 border-b border-r border-glass-border rounded-br-3xl pointer-events-none" />
                </motion.div>
            </div>
        </section>
    );
