...
export default function ResultsPage() {
    ...
    useEffect(() => {
        ...
        if (idx !== -1 && attempt._id && !history[idx].dbId) {
            history[idx].dbId =
                attempt._id?.toString?.() ?? String(attempt._id);
    ...
    return (
        <ResultsDisplay
            ...
            // Protected nested properties to prevent undefined crash
            insights={{
                strengths: attempt.insights?.strengths || [],
                weaknesses: attempt.insights?.weaknesses || [],
                recommendedTopics: attempt.insights?.recommendedTopics || [],
            }}
