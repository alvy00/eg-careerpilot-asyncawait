...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0C1B] flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-orange-500/30 selection:text-orange-200">
            ...
            <div className="hidden lg:flex absolute left-[5%] top-1/2 -translate-y-1/2 flex-col items-center opacity-20 select-none pointer-events-none animate-[bounce_4s_ease-in-out_infinite]">
            ...
            <div className="hidden lg:flex absolute right-[5%] top-1/2 -translate-y-1/2 flex-col items-center opacity-20 select-none pointer-events-none animate-[bounce_4s_ease-in-out_infinite_1.5s]">
            ...
            <div className="w-full max-w-[480px] z-10 group/card transition-all duration-500 flex flex-col">
                {/* PC-Only Animated Back Button */}
                <Link
                    href="/"
                ...
                <div className="bg-[#161B22]/30 backdrop-blur-2xl border border-white/10 group-hover/card:border-white/20 rounded-[32px] p-8 md:p-10 shadow-2xl relative transition-all duration-500 overflow-hidden before:absolute before:inset-0 before:-z-10 before:bg-gradient-to-b before:from-orange-500/5 before:to-transparent before:opacity-0 group-hover/card:before:opacity-100 before:transition-opacity before:duration-500">
                    {/* Logo & Header */}
                    <div className="flex flex-col items-center mb-8 transform transition-transform duration-500 group-hover/card:-translate-y-1">
                        <Link
                            href="/"
                        ...
                        <h1 className="text-white font-bold tracking-tight text-lg uppercase tracking-[0.05em]">
                            Join CareerPilot
                        </h1>
                        <p className="text-gray-400 text-[10px] uppercase tracking-[0.2em] font-semibold mt-1">
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1 transition-colors group-focus-within/name:text-orange-400">
                                Full Name
                            </label>
                            <div className="relative group/name">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within/name:text-orange-500 group-focus-within/name:scale-110 transition-all duration-300" />
                                <input
                                    required
                                    type="text"
                                    value={fullName}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1 transition-colors group-focus-within/confirm:text-orange-400">
                                    Confirm
                                </label>
                                <div className="relative group/confirm">
                                    <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within/confirm:text-orange-500 group-focus-within/confirm:scale-110 transition-all duration-300" />
                                    <input
                                        required
                                        type="password"
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    ...
                                    <Rocket className="w-4 h-4 relative z-10 group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1 transition-transform duration-300" />
                                </>
                            )}
                        </button>
                    </form>
                ...
                {/* Footer Badges */}
                <div className="flex justify-between px-4 mt-8 opacity-30 group-hover/card:opacity-50 transition-opacity duration-500">
                    <div className="flex flex-col items-start">
                        <div className="flex items-center space-x-2 text-[10px] font-bold text-gray-500 uppercase tracking-[0.15em]">
                            <ShieldCheck className="w-4 h-4 text-emerald-500/80" />
                            <span>Enterprise Secure</span>
                        </div>
                        <span className="text-[8px] text-gray-600 mt-1 uppercase pl-6 font-semibold">
                            AES-256 Encryption
                        </span>
                    </div>
                    <div className="flex flex-col items-end">
                        ...
                        <span className="text-[8px] text-gray-600 mt-1 uppercase pr-6 font-semibold">
                            Neural Acceleration
                        </span>
                    </div>
                </div>
